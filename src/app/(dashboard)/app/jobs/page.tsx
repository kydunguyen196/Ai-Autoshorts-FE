    ...
    <div>
      ...
      <Card>
        ...
        {publishMutation.isError ? (
          <p className="mt-2 text-sm text-danger">{getErrorMessage(publishMutation.error)}</p>
        ) : null}
        ...
        <div className="mt-5">
          {jobsQuery.isLoading ? (
            ...
            <p className="text-sm text-danger">Failed to load jobs feed.</p>
              ...
              <table className="min-w-[1280px] text-left text-sm">
                ...
                <tbody>
                  {filteredItems.map((job) => {
                    ...
                    return (
                      <tr key={job.jobId} className="border-t border-border align-top">
                        ...
                        <td className="px-4 py-3">
                          ...
                          {job.selectedForPublish ? <p className="mt-1 text-xs text-success">Selected</p> : null}
                        </td>
                        <td className="px-4 py-3">
                          <PublishStatusBadge status={job.publishStatus} />
                        </td>
                        <td className="px-4 py-3 text-xs text-faint">{job.generationGroupId || "-"}</td>
                        <td className="px-4 py-3 text-muted">{formatDateTime(job.updatedAt)}</td>
                        <td className="px-4 py-3">
