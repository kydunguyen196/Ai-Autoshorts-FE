  ...
  return (
    <div>
      ...
      <Card className="max-w-5xl">
        <div className="mb-5 rounded-xl border border-accent-2/30 bg-accent-2/10 px-4 py-3 text-sm text-foreground">
        ...
        >
          ...
          <div className="grid gap-4 md:grid-cols-5">
            ...
            <label className="block space-y-2 md:col-span-3">
              <span className="text-sm text-strong">Content Style (optional override)</span>
              <Input
                value={contentStyle}
            ...
            <label className="block space-y-2">
              <span className="text-sm text-strong">Voice ID</span>
              <Input
                value={voiceId}
            ...
            <label className="block space-y-2">
              <span className="text-sm text-strong">Duration (seconds)</span>
              <Input
                type="number"
            ...
            <label className="block space-y-2">
              <span className="text-sm text-strong">Variant Count</span>
              <Input
                type="number"
                min={1}
                max={10}
          ...
          <div className="rounded-xl border border-success/30 bg-success/10 p-4">
            <h3 className="text-sm font-semibold uppercase tracking-wide text-success">Commercial Quality Controls</h3>
            <div className="mt-4 grid gap-4 md:grid-cols-3">
              <label className="block space-y-2">
                <span className="text-sm text-strong">Niche</span>
              ...
              <label className="block space-y-2">
                <span className="text-sm text-strong">Platform</span>
              ...
              <label className="block space-y-2">
                <span className="text-sm text-strong">Quality Preset</span>
              ...
              <label className="block space-y-2">
                <span className="text-sm text-strong">Subtitle Style</span>
              ...
              <label className="block space-y-2">
                <span className="text-sm text-strong">Visual Mode</span>
              ...
              <label className="block space-y-2">
                <span className="text-sm text-strong">Voice Persona</span>
                <Input value={voicePersona} onChange={(event) => setVoicePersona(event.target.value)} />
              </label>

              <label className="block space-y-2 md:col-span-3">
                <span className="text-sm text-strong">Voice Provider Override</span>
                <Input
                  value={voiceProvider}
          ...
          <div className="rounded-xl border border-border bg-surface p-4">
            <h3 className="text-sm font-semibold uppercase tracking-wide text-strong">Character Story Ads Inputs</h3>
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              ...
              <label className="block space-y-2">
                <span className="text-sm text-strong">Character Campaign</span>
                <Select
              ...
              <label className="block space-y-2">
                <span className="text-sm text-strong">Story Angle</span>
                <Input
                  value={storyAngle}
              ...
              <label className="block space-y-2">
                <span className="text-sm text-strong">Product Placement Mode</span>
                <Input
              ...
              <label className="block space-y-2">
                <span className="text-sm text-strong">Ad Disclosure Mode</span>
                <Input
              ...
              <label className="block space-y-2">
                <span className="text-sm text-strong">Scene Count Target</span>
                <Input
                  type="number"
                  min={1}
                  max={20}
              ...
              <label className="block space-y-2 md:col-span-2">
                <span className="text-sm text-strong">Character Consistency Mode</span>
                <Input
            ...
            {profilesQuery.isError ? (
              <p className="mt-3 text-xs text-warning-strong">Could not load character profiles for this channel.</p>
            ) : null}
          ...
          <div className="flex items-center gap-3">
            ...
            {!activeChannelId ? (
              <p className="text-sm text-warning-strong">Select an active channel in the top bar first.</p>
            ) : null}
          </div>
        </form>
      </Card>
